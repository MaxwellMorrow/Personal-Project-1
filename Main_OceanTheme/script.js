const trashContainer = document.querySelector(".trash_container")
...
img.style.left = `${randonNumberBetween(0,100)}vw`
img.style.setProperty("--rotation", `${randonNumberBetween(-30,30)}deg`)
